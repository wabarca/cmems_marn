function [sst_cmap,vel_cmap] = hycom_cmap(nbase)
if nargin < 1
   nbase = size(get(gcf,'colormap'),1);
end

cm1 = [1.0000, 1.0000, 1.0000;
...
for i=1:nbase
   ...
   w0 = l1-1-rind;
   w1 = 1.-w0;
   r = w0*cm1(1,l0)+w1*cm1(1,l1);
   g = w0*cm1(2,l0)+w1*cm1(2,l1);
   b = w0*cm1(3,l0)+w1*cm1(3,l1);
   sst_cmap(i,:) = [r g b];
end
...
for i=1:nbase
   ...
   w0 = l1-1-rind;
   w1 = 1.-w0;
   r = w0*cm2(1,l0)+w1*cm2(1,l1);
   g = w0*cm2(2,l0)+w1*cm2(2,l1);
   b = w0*cm2(3,l0)+w1*cm2(3,l1);
   vel_cmap(i,:) = [r g b];
end
